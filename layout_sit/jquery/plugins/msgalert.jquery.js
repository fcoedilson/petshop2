...
(function($){
	$.fn.MsgAlert = function(options) {
		...
		var defaults = {  
			...
			intervalTime : 0, //time between the creation of one alert and another one
			cssPosition: 'fixed', // css position, fixed is the default
			cssRight: 10,
			title: 'Msg Alert', //will appear at the dialog title bar if title inst' set at the selector
		...
		return this.each(function() { 
			...
			if (alertContent == "") { alertContent = options.content; }
			...
			if (alertTitle == "") { alertTitle = options.title; }	
